...
COMMANDS = {
    ...
    0xFF4D: u'Передать произвольную TLV структуру для предмета расчёта',
    ...
    0xFF45: u'Закрытие чека расширенное v2',
    0xFF46: u'Операция v2'
}
